...
file_path = '/content/traffic prediction 2020-2022 new.csv'
...
gdf = gpd.read_file('/content/traffic prediction 2020-2022 new.csv')  # استبدال 'shapefile.shp' بمسار ملف البيانات الجغرافية الخاص بك
...
user_input = st.text_input("Enter population:", "Default value")
